...
<node id="4">
  ...
  <data key="d6">region</data>
  <data key="d0">73</data>
  <data key="d1">region</data>
  <data key="d2">SimpleName</data>
  <data key="d3">VariableDeclarator</data>
  <data key="d4">true</data>
</node>
...
<node id="6">
  <data key="d6">cf1</data>
  <data key="d0">219</data>
  <data key="d1">"cf1"</data>
...
<node id="8">
  <data key="d5">UnknownType</data>
  <data key="d6">conf</data>
  <data key="d0">221</data>
  <data key="d1">conf</data>
  <data key="d2">SimpleName</data>
...
<node id="9">
  ...
  <data key="d6">getMethodName</data>
  <data key="d0">221</data>
  <data key="d1">getMethodName</data>
  <data key="d2">SimpleName</data>
...
<node id="10">
  <data key="d5">UnknownType</data>
  <data key="d6">testName</data>
  <data key="d0">221</data>
  <data key="d1">testName</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
  <data key="d4">true</data>
</node>
<node id="11">
  <data key="d0">221</data>
  <data key="d1">testName.getMethodName()</data>
...
<node id="29">
  ...
  <data key="d6">testBlocksStoredWhenCachingDisabled</data>
  <data key="d0">377</data>
  <data key="d1">testBlocksStoredWhenCachingDisabled</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodDeclaration</data>
  <data key="d4">true</data>
</node>
...
<node id="33">
  <data key="d0">378</data>
  <data key="d1">TABLE = Bytes.toBytes("testBlocksReadWhenCachingDisabled")</data>
  <data key="d2">VariableDeclarator</data>
...
<node id="34">
  <data key="d0">378</data>
  <data key="d1">byte[] TABLE = Bytes.toBytes("testBlocksReadWhenCachingDisabled")</data>
...
<node id="37">
  <data key="d6">testBlocksReadWhenCachingDisabled</data>
  <data key="d0">378</data>
  <data key="d1">"testBlocksReadWhenCachingDisabled"</data>
  <data key="d2">StringLiteralExpr</data>
  <data key="d3">MethodCallExpr</data>
  <data key="d4">true</data>
</node>
...
<node id="40">
  <data key="d0">378</data>
  <data key="d1">Bytes.toBytes("testBlocksReadWhenCachingDisabled")</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
  <data key="d4">true</data>
</node>
...
<node id="46">
  <data key="d0">379</data>
  <data key="d1">String FAMILY = "cf1"</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
  <data key="d4">true</data>
</node>
<node id="47">
  <data key="d5">UnknownType</data>
  <data key="d6">blockCache</data>
  <data key="d0">381</data>
  <data key="d1">blockCache</data>
  <data key="d2">SimpleName</data>
  <data key="d3">VariableDeclarator</data>
  <data key="d4">true</data>
</node>
...
<node id="50">
  <data key="d0">381</data>
  <data key="d1">blockCache = BlockCacheFactory.createBlockCache(conf)</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
  <data key="d4">true</data>
</node>
<node id="51">
  <data key="d0">381</data>
  <data key="d1">BlockCache blockCache = BlockCacheFactory.createBlockCache(conf)</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
  <data key="d4">true</data>
</node>
...
<node id="54">
  <data key="d5">otherMethodCall</data>
  <data key="d6">createBlockCache</data>
  <data key="d0">381</data>
  <data key="d1">createBlockCache</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
  <data key="d4">true</data>
</node>
<node id="55">
  <data key="d5">UnknownType</data>
  <data key="d6">BlockCacheFactory</data>
  <data key="d0">381</data>
  <data key="d1">BlockCacheFactory</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
  <data key="d4">true</data>
</node>
<node id="56">
  <data key="d0">381</data>
  <data key="d1">BlockCacheFactory.createBlockCache(conf)</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
  <data key="d4">true</data>
</node>
...
<node id="58">
  <data key="d5">otherMethodCall</data>
  <data key="d6">initHRegion</data>
  <data key="d0">382</data>
  <data key="d1">initHRegion</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
  <data key="d4">true</data>
</node>
<node id="59">
  <data key="d0">382</data>
  <data key="d1">initHRegion(TABLE, testName.getMethodName(), conf, FAMILY, blockCache)</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">AssignExpr</data>
  <data key="d4">true</data>
</node>
...
<node id="63">
  <data key="d6">=</data>
  <data key="d0">382</data>
  <data key="d1">this.region = initHRegion(TABLE, testName.getMethodName(), conf, FAMILY, blockCache)</data>
 ...
 */
private HRegion initHRegion(byte[] tableName, String callingMethod, Configuration conf, String family, BlockCache blockCache) throws IOException {
    TableDescriptorBuilder builder = TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName));
    for (int i = 0; i &lt; BLOOM_TYPE.length; i++) {
        BloomType bloomType = BLOOM_TYPE[i];
        builder.setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes(family + "_" + bloomType)).setBlocksize(1).setBloomFilterType(bloomType).build());
    }
...
<node id="91">
  <data key="d0">101</data>
  <data key="d1">byte[] tableName</data>
...
<node id="94">
  ...
  <data key="d0">101</data>
  <data key="d1">tableName</data>
  <data key="d2">SimpleName</data>
  <data key="d3">Parameter</data>
</node>
<node id="95">
  <data key="d0">101</data>
  <data key="d1">String callingMethod</data>
  <data key="d2">Parameter</data>
  <data key="d3">MethodDeclaration</data>
</node>
<node id="96">
...
<node id="98">
  <data key="d5">java.lang.String</data>
  <data key="d6">callingMethod</data>
  <data key="d0">101</data>
  <data key="d1">callingMethod</data>
  <data key="d2">SimpleName</data>
  <data key="d3">Parameter</data>
</node>
<node id="99">
  <data key="d0">101</data>
  <data key="d1">Configuration conf</data>
  <data key="d2">Parameter</data>
  <data key="d3">MethodDeclaration</data>
</node>
<node id="100">
...
<node id="101">
  <data key="d5">nonQualifiedClassName</data>
  <data key="d6">Configuration</data>
  <data key="d0">101</data>
  <data key="d1">Configuration</data>
  <data key="d2">SimpleName</data>
  <data key="d3">ClassOrInterfaceType</data>
...
<node id="103">
  ...
  <data key="d1">String family</data>
  <data key="d2">Parameter</data>
  <data key="d3">MethodDeclaration</data>
</node>
<node id="104">
...
<node id="107">
  <data key="d0">102</data>
  <data key="d1">BlockCache blockCache</data>
  <data key="d2">Parameter</data>
  <data key="d3">MethodDeclaration</data>
</node>
<node id="108">
...
<node id="116">
  ...
  <data key="d1">TableDescriptorBuilder builder = TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName))</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
</node>
<node id="117">
  <data key="d0">103</data>
  <data key="d1">builder = TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName))</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
</node>
<node id="118">
  <data key="d0">103</data>
  <data key="d1">TableDescriptorBuilder</data>
  <data key="d2">ClassOrInterfaceType</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="119">
...
<node id="120">
  ...
  <data key="d0">103</data>
  <data key="d1">builder</data>
  <data key="d2">SimpleName</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="121">
  <data key="d0">104</data>
  <data key="d1">TableDescriptorBuilder.newBuilder(TableName.valueOf(tableName))</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="122">
...
<node id="123">
  ...
  <data key="d0">104</data>
  <data key="d1">newBuilder</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="124">
  <data key="d0">104</data>
  <data key="d1">TableName.valueOf(tableName)</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="125">
...
<node id="126">
  <data key="d5">otherMethodCall</data>
  <data key="d6">valueOf</data>
  <data key="d0">104</data>
  <data key="d1">valueOf</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="127">
...
<node id="128">
  ...
  <data key="d1">RegionInfo info = RegionInfoBuilder.newBuilder(TableName.valueOf(tableName)).build()</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
</node>
<node id="129">
  <data key="d0">111</data>
  <data key="d1">info = RegionInfoBuilder.newBuilder(TableName.valueOf(tableName)).build()</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
</node>
<node id="130">
  <data key="d0">111</data>
  <data key="d1">RegionInfo</data>
  <data key="d2">ClassOrInterfaceType</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="131">
  <data key="d5">nonQualifiedClassName</data>
  <data key="d6">RegionInfo</data>
  <data key="d0">111</data>
  <data key="d1">RegionInfo</data>
  <data key="d2">SimpleName</data>
  <data key="d3">ClassOrInterfaceType</data>
...
<node id="133">
  <data key="d0">111</data>
  <data key="d1">RegionInfoBuilder.newBuilder(TableName.valueOf(tableName)).build()</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="134">
  <data key="d0">111</data>
  <data key="d1">RegionInfoBuilder.newBuilder(TableName.valueOf(tableName))</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="135">
  <data key="d5">UnknownType</data>
  <data key="d6">RegionInfoBuilder</data>
  <data key="d0">111</data>
  <data key="d1">RegionInfoBuilder</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
</node>
<node id="136">
...
<node id="142">
  ...
  <data key="d1">Path path = new Path(DIR + callingMethod)</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
</node>
<node id="143">
  <data key="d0">112</data>
  <data key="d1">path = new Path(DIR + callingMethod)</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
</node>
<node id="144">
...
<node id="147">
  <data key="d0">112</data>
  <data key="d1">new Path(DIR + callingMethod)</data>
...
<node id="150">
  <data key="d0">112</data>
  <data key="d1">DIR + callingMethod</data>
...
<node id="157">
  <data key="d5">java.lang.String</data>
  <data key="d6">DEPRECATED_BLOCKCACHE_BLOCKSIZE_KEY</data>
  <data key="d0">108</data>
  <data key="d1">DEPRECATED_BLOCKCACHE_BLOCKSIZE_KEY</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
</node>
<node id="158">
  <data key="d0">113</data>
  <data key="d1">FirstLevelBlockCache l1Cache = createFirstLevelCache(conf)</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
</node>
<node id="159">
  <data key="d0">113</data>
  <data key="d1">l1Cache = createFirstLevelCache(conf)</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
</node>
<node id="160">
  <data key="d0">113</data>
  <data key="d1">FirstLevelBlockCache</data>
  <data key="d2">ClassOrInterfaceType</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="161">
  <data key="d5">nonQualifiedClassName</data>
  <data key="d6">FirstLevelBlockCache</data>
  <data key="d0">113</data>
  <data key="d1">FirstLevelBlockCache</data>
  <data key="d2">SimpleName</data>
  <data key="d3">ClassOrInterfaceType</data>
...
<node id="162">
  <data key="d5">UnknownType</data>
  <data key="d6">l1Cache</data>
  <data key="d0">113</data>
  <data key="d1">l1Cache</data>
  <data key="d2">SimpleName</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="163">
  <data key="d0">113</data>
  <data key="d1">createFirstLevelCache(conf)</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="164">
  <data key="d5">otherMethodCall</data>
  <data key="d6">createFirstLevelCache</data>
  <data key="d0">113</data>
  <data key="d1">createFirstLevelCache</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="165">
...
<node id="166">
  ...
  <data key="d1">boolean useExternal = conf.getBoolean(EXTERNAL_BLOCKCACHE_KEY, EXTERNAL_BLOCKCACHE_DEFAULT)</data>
  <data key="d2">VariableDeclarationExpr</data>
  <data key="d3">ExpressionStmt</data>
</node>
<node id="167">
  <data key="d0">117</data>
  <data key="d1">useExternal = conf.getBoolean(EXTERNAL_BLOCKCACHE_KEY, EXTERNAL_BLOCKCACHE_DEFAULT)</data>
  <data key="d2">VariableDeclarator</data>
  <data key="d3">VariableDeclarationExpr</data>
</node>
<node id="168">
...
<node id="169">
  ...
  <data key="d6">useExternal</data>
  <data key="d0">117</data>
  <data key="d1">useExternal</data>
  <data key="d2">SimpleName</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="170">
  <data key="d0">117</data>
  <data key="d1">conf.getBoolean(EXTERNAL_BLOCKCACHE_KEY, EXTERNAL_BLOCKCACHE_DEFAULT)</data>
  <data key="d2">MethodCallExpr</data>
  <data key="d3">VariableDeclarator</data>
</node>
<node id="171">
...
<node id="172">
  <data key="d5">otherMethodCall</data>
  <data key="d6">getBoolean</data>
  <data key="d0">117</data>
  <data key="d1">getBoolean</data>
  <data key="d2">SimpleName</data>
  <data key="d3">MethodCallExpr</data>
</node>
<node id="173">
  <data key="d5">java.lang.String</data>
  <data key="d6">EXTERNAL_BLOCKCACHE_KEY</data>
  <data key="d0">117</data>
  <data key="d1">EXTERNAL_BLOCKCACHE_KEY</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
</node>
<node id="174">
  <data key="d5">boolean</data>
  <data key="d6">EXTERNAL_BLOCKCACHE_DEFAULT</data>
  <data key="d0">117</data>
  <data key="d1">EXTERNAL_BLOCKCACHE_DEFAULT</data>
  <data key="d2">SimpleName</data>
  <data key="d3">NameExpr</data>
</node>
<node id="175">
  ...
  <data key="d0">107</data>
  <data key="d1">public static BlockCache createBlockCache(Configuration conf) {
    if (conf.get(DEPRECATED_BLOCKCACHE_BLOCKSIZE_KEY) != null) {
        LOG.warn("The config key {} is deprecated now, instead please use {}. In future release " + "we will remove the deprecated config.", DEPRECATED_BLOCKCACHE_BLOCKSIZE_KEY, BLOCKCACHE_BLOCKSIZE_KEY);
    }
    FirstLevelBlockCache l1Cache = createFirstLevelCache(conf);
...
<edge source="115" target="142">
  <data key="d8">AST</data>
</edge>
<edge source="115" target="116">
  <data key="d8">AST</data>
</edge>
<edge source="115" target="128">
  <data key="d8">AST</data>
</edge>
...
<edge source="154" target="181">
  <data key="d8">NEXT_TOKEN</data>
</edge>
<edge source="155" target="180">
  <data key="d8">LAST_READ</data>
</edge>
