...
<node id="8">
  <data key="d2">3466</data>
  <data key="d3">int fileClientMessageIndex = 393</data>
  <data key="d4">VariableDeclarationExpr</data>
  <data key="d5">ExpressionStmt</data>
  <data key="d6">true</data>
</node>
<node id="9">
  <data key="d1">393</data>
  <data key="d2">3466</data>
...
<node id="12">
  <data key="d2">3466</data>
  <data key="d3">fileClientMessageIndex = 393</data>
...
<node id="15">
  <data key="d2">3467</data>
  <data key="d3">encoded = AtomicRefContainsCodec.encodeResponse(aBoolean)</data>
  <data key="d4">VariableDeclarator</data>
  <data key="d5">VariableDeclarationExpr</data>
  <data key="d6">true</data>
</node>
<node id="16">
  <data key="d2">3467</data>
  <data key="d3">ClientMessage encoded = AtomicRefContainsCodec.encodeResponse(aBoolean)</data>
  <data key="d4">VariableDeclarationExpr</data>
  <data key="d5">ExpressionStmt</data>
  <data key="d6">true</data>
</node>
...
<node id="18">
  <data key="d0">UnknownType</data>
  <data key="d1">AtomicRefContainsCodec</data>
  <data key="d2">3467</data>
  <data key="d3">AtomicRefContainsCodec</data>
  <data key="d4">SimpleName</data>
  <data key="d5">NameExpr</data>
  <data key="d6">true</data>
</node>
<node id="19">
  <data key="d2">3467</data>
  <data key="d3">AtomicRefContainsCodec.encodeResponse(aBoolean)</data>
  <data key="d4">MethodCallExpr</data>
  <data key="d5">VariableDeclarator</data>
  <data key="d6">true</data>
</node>
...
<node id="22">
  <data key="d0">UnknownType</data>
  <data key="d1">aBoolean</data>
  <data key="d2">3467</data>
  <data key="d3">aBoolean</data>
  <data key="d4">SimpleName</data>
  <data key="d5">NameExpr</data>
  <data key="d6">true</data>
</node>
<node id="23">
  <data key="d0">otherMethodCall</data>
  <data key="d1">encodeResponse</data>
  <data key="d2">3467</data>
  <data key="d3">encodeResponse</data>
  <data key="d4">SimpleName</data>
  <data key="d5">MethodCallExpr</data>
  <data key="d6">true</data>
</node>
...
<node id="28">
  ...
  <data key="d1">test_AtomicRefContainsCodec_encodeResponse</data>
  <data key="d2">3465</data>
  <data key="d3">test_AtomicRefContainsCodec_encodeResponse</data>
  <data key="d4">SimpleName</data>
...
<node id="34">
  ...
  <data key="d2">96</data>
  <data key="d3">public static ClientMessage encodeResponse(boolean response) {
...
<node id="36">
  <data key="d2">96</data>
  <data key="d3">boolean response</data>
...
<node id="50">
  <data key="d2">98</data>
  <data key="d3">ClientMessage.Frame initialFrame = new ClientMessage.Frame(new byte[RESPONSE_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE)</data>
  <data key="d4">VariableDeclarationExpr</data>
  <data key="d5">ExpressionStmt</data>
</node>
<node id="51">
  <data key="d2">98</data>
  <data key="d3">initialFrame = new ClientMessage.Frame(new byte[RESPONSE_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE)</data>
  <data key="d4">VariableDeclarator</data>
  <data key="d5">VariableDeclarationExpr</data>
</node>
<node id="52">
...
<node id="57">
  <data key="d2">98</data>
  <data key="d3">new ClientMessage.Frame(new byte[RESPONSE_INITIAL_FRAME_SIZE], UNFRAGMENTED_MESSAGE)</data>
...
<node id="62">
  <data key="d2">98</data>
  <data key="d3">new byte[RESPONSE_INITIAL_FRAME_SIZE]</data>
...
<node id="64">
  <data key="d2">98</data>
  <data key="d3">[RESPONSE_INITIAL_FRAME_SIZE]</data>
  <data key="d4">ArrayCreationLevel</data>
  <data key="d5">ArrayCreationExpr</data>
</node>
<node id="65">
  <data key="d0">int</data>
  <data key="d1">RESPONSE_INITIAL_FRAME_SIZE</data>
  <data key="d2">98</data>
  <data key="d3">RESPONSE_INITIAL_FRAME_SIZE</data>
  <data key="d4">SimpleName</data>
  <data key="d5">NameExpr</data>
...
<node id="67">
  <data key="d2">99</data>
  <data key="d3">encodeInt(initialFrame.content, TYPE_FIELD_OFFSET, RESPONSE_MESSAGE_TYPE)</data>
  <data key="d4">MethodCallExpr</data>
  <data key="d5">ExpressionStmt</data>
</node>
<node id="68">
...
<node id="73">
  <data key="d0">int</data>
  <data key="d1">RESPONSE_MESSAGE_TYPE</data>
  <data key="d2">99</data>
  <data key="d3">RESPONSE_MESSAGE_TYPE</data>
  <data key="d4">SimpleName</data>
  <data key="d5">NameExpr</data>
</node>
<node id="74">
  <data key="d2">100</data>
  <data key="d3">encodeBoolean(initialFrame.content, RESPONSE_RESPONSE_FIELD_OFFSET, response)</data>
  <data key="d4">MethodCallExpr</data>
  <data key="d5">ExpressionStmt</data>
</node>
<node id="75">
  <data key="d0">otherMethodCall</data>
  <data key="d1">encodeBoolean</data>
  <data key="d2">100</data>
  <data key="d3">encodeBoolean</data>
  <data key="d4">SimpleName</data>
  <data key="d5">MethodCallExpr</data>
</node>
<node id="76">
...
<node id="79">
  <data key="d0">int</data>
  <data key="d1">RESPONSE_RESPONSE_FIELD_OFFSET</data>
  <data key="d2">100</data>
  <data key="d3">RESPONSE_RESPONSE_FIELD_OFFSET</data>
  <data key="d4">SimpleName</data>
  <data key="d5">NameExpr</data>
</node>
<node id="80">
